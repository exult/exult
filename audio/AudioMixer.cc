...
id_counter(0)
{
	...
	stream = SDL_OpenAudioDeviceStream(SDL_AUDIO_DEVICE_DEFAULT_OUTPUT, &desired, sdlAudioCallback, this);
...
void AudioMixer::sdlAudioCallback(void *userdata, SDL_AudioStream *stream, int len, int maxlen)
{
