...
{
	var answer;
	var var0001; // Part of Draxinar's main function?
	...
	answer = UI_input_numeric_value(0x0000, 0x001E, 0x0001, 0x0000); // (lowest_option, highest_option, increment, default)
	...
	if (answer == 14) // The original 'correct' incorrect answer.
	{
