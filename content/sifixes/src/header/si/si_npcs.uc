...
enum silver_seed_npcs
{
	ISSTANAR = -234,		// Commander of The Serpent's Fang.
	ELISSA = -235,			// Order Mage of the First Rank.
	SUROK = -236,			// Healer of Serpent's Fang.
	TSANDAR = -237,			// SubCommander, aide to the Garrison Commander.
	SHAL = -238,			// The Fiend is a madman of Chaos searching for his ring.
	YUREL = -239,			// The catman was an "experiment long ago gone wrong."
	DRAXINAR = -240			// The green dragon says "My friends, however, call me 'Stumpy'."
};

// SI unused NPCs 241-255, 286, and 288-292 have been placed to the west of Vasculio in the House of the Dead.
// They are not listed here, but are ready for any future mod use built off of this work.
