...
USECODE_INTRINSIC_PTR(get_random),                               // 0x00
		...
		USECODE_INTRINSIC_PTR(UNKNOWN),                  // 0x78 - UNUSED - Seems like it could be
														 // set_orrery, but does nothing
		USECODE_INTRINSIC_PTR(UNKNOWN),                  // 0x79 - UNUSED - Same as BG 0x64/SIB 0x78?
		...
		USECODE_INTRINSIC_PTR(UNKNOWN),                  // 0x95 - UNUSED - seems like it could be
														 // sib_path_run_usecode, but does nothing
		USECODE_INTRINSIC_PTR(can_avatar_reach_pos),     // 0x96
		USECODE_INTRINSIC_PTR(UNKNOWN),                  // 0x97 - UNUSED - seems like it could be
		...
		USECODE_INTRINSIC_PTR(UNKNOWN),                  // 0x9d - UNUSED - Same as BG 0x83/SIB 0x9c?
														 // Something with palettes
